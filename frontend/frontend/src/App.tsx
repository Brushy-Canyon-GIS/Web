      ...
      for (const layer of selectedLayers) {
        try {
          const res = await fetch(
            `http://localhost:8000/api/v1/geologic/${layer}?limit=100`
          );
          ...
          <div className="options-list">
            ...
            <label className="layer-option">
              <input
                ...
                checked={selectedLayers.includes("measured_sections_all_areas")}
              />
            ...
            <label className="layer-option">
              <input
                ...
                onChange={() => handleLayerChange("brushy_intersect_final2")}
